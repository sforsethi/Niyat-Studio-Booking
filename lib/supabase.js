...
const bookingHelpers = {
  ...
  async checkBookingConflict(date, startTime, duration) {
    ...
    console.log('Checking conflicts for:', { date, startTime, duration, startTimeMinutes, endTimeMinutes });
    console.log('Existing bookings to check:', existingBookings);
    ...
    for (const booking of existingBookings) {
      ...
      console.log('Overlap check:', {
        condition1: `${startTimeMinutes} < ${existingEndMinutes}`,
        result1: startTimeMinutes < existingEndMinutes,
        condition2: `${endTimeMinutes} > ${existingStartMinutes}`,
        result2: endTimeMinutes > existingStartMinutes,
        hasOverlap
      });
